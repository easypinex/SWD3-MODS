...
2026-09-06。已完成 **[SWD3 MOD Studio 發佈與維護桌面版 0.3.2](DESKTOP.md)**：找回作品、保存草稿、原 ID 升版、私人新建、查詢文字／檔案／版本歷史、失敗恢復及 HTML 核對報告。已用私人作品實測桌面更新 0.5 → 0.6、新建 0.7，並重啟驗證紀錄；見[桌面驗收](evidence/desktop-20260906/README.md)。0.3.2 保留原啟動選單，只替換「進階 → Steam 模組開發工具」按鈕，並支援還原；已由使用者實測確認開啟新版，驗收見 DESKTOP。原 CLI 階段保留在 [0.2.0](RELEASES.md)／[M0](PROTOTYPE.md)。已完成原版開發工具按鈕修補；尚未重現原工具現場卡死；下方保留原靜態診斷與備案。研究狀態見[研究清冊](../../README.md)。
