...
2026-09-06。已完成 **[SWD3 MOD Studio 發佈與維護桌面版 0.3.1](DESKTOP.md)**：找回作品、保存草稿、原 ID 升版、私人新建、查詢文字／檔案／版本歷史、失敗恢復及 HTML 核對報告。已用私人作品實測桌面更新 0.5 → 0.6、新建 0.7，並重啟驗證紀錄；見[桌面驗收](evidence/desktop-20260906/README.md)。0.3.1 新增可接管／還原的 Steam 啟動入口，入口驗收見 DESKTOP。原 CLI 階段保留在 [0.2.0](RELEASES.md)／[M0](PROTOTYPE.md)。尚未製作原工具修正版或重現原工具現場卡死；下方保留原靜態診斷與備案。研究狀態見[研究清冊](../../README.md)。
